        ...
        <header
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    <motion.a href="https://www.github.com/julianomoser" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mx-3"
                    >
                    ...
                    <motion.a href="https://br.linkedin.com/in/juliano-moser-de-jesus-883baa256" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 ml-3"
                    >
                    ...
                    <motion.button
                        ...
                        className={`ml-5 flex items-center justify-center rounded-full p-1 w-8
            ...
            '>
                        ...
                        <nav className="flex items-center justify-center flex-wrap mt-2">
                            ...
                            <motion.a href="https://www.linkedin.com/julianomoser" target={"_blank"}
                                whileHover={{ y: -2 }}
                                whileTap={{ scale: 0.9 }}
