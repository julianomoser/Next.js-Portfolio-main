...
const about = () => {
    return (
        <>
            <Head>
                <title>Juliano Moser | About Page</title>
                <meta name='description' content='' />
            </Head>
            <TransitionEffect />
            <main className='flex w-full flex-col items-center justify-center dark:text-light'>
                <Layout className='pt-16'>
                    <AnimatedText text="Passion Fuels Purpose!" className='mb-16 lg:!text-7xl sm:!text-6xl xl:!text-4xl sm:mb-8' />
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        <div className='col-span-3 flex flex-col items-start justify-start lg:col-span-4 md:order-2 md:col-span-8'>
                            ...
                            <p className='font-medium'>
                                Hi, I'm Juliano Moser, a Java fullstack developer and UI/UX designer with a passion for creating beautiful, functional,
                            ...
                            <p className='font-medium'>
                                Whether I'm working on a application, website or
                        ...
                        '>
                            ...
                            <Image src={profilePic} alt='Juliano Moser' className='w-full h-auto rounded-2xl'
                                priority
